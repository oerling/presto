...
import static com.facebook.presto.spi.MoreByteArrays.setInts;
        ...
        extends BlockEncodingBuffers
{
    ...
    public void accumulateRowSizes(int[] rowSizes)
    {
        ...
        keyBuffers.accumulateRowSizes(offsetsCopy, positionCount, rowSizes);

        System.arraycopy(offsets, 0, offsetsCopy, 0, positionCount + 1);
        valueBuffers.accumulateRowSizes(offsetsCopy, positionCount, rowSizes);
    }
    ...
    protected void accumulateRowSizes(int[] positionOffsets, int positionCount, int[] rowSizes)
    {
        ...
        keyBuffers.accumulateRowSizes(positionOffsets, positionCount, rowSizes);
        valueBuffers.accumulateRowSizes(offsetsCopy, positionCount, rowSizes);
    }
    ...
    private void appendHashTables()
    {
        ...
        hashTablesBuffer = ensureCapacity(hashTablesBuffer, hashTableBufferIndex + hashTablesSize * ARRAY_INT_INDEX_SCALE, 2.0f, true);
