...
import static com.facebook.presto.operator.PageAssertions.createPage;
...
public class TestOptimizedPartitionedOutputOperator
{
    ...
    public void testEmptyPage()
    {
        ...
        Page page = createPage(ImmutableList.of(BIGINT), 0, true, false, false, ImmutableList.of());
    ...
    public void testPageWithNoBlocks()
    {
        ...
        Page page = createPage(ImmutableList.of(), 1, false, false, false, ImmutableList.of());
    ...
    private void testPartitionedSinglePage(List<Type> targetTypes)
    {
        ...
        Page page = createPage(targetTypes, POSITION_COUNT, true, false, false, ImmutableList.of());
        ...
        page = createPage(targetTypes, POSITION_COUNT, true, false, true, ImmutableList.of(DICTIONARY, RUN_LENGTH, DICTIONARY, RUN_LENGTH));
        testPartitioned(types, ImmutableList.of(page), new DataSize(128, MEGABYTE));
        testPartitioned(types, ImmutableList.of(page), new DataSize(1, KILOBYTE));

        page = createPage(targetTypes, POSITION_COUNT, true, false, true, ImmutableList.of(RUN_LENGTH, DICTIONARY, RUN_LENGTH, DICTIONARY));
        testPartitioned(types, ImmutableList.of(page), new DataSize(128, MEGABYTE));
        testPartitioned(types, ImmutableList.of(page), new DataSize(1, KILOBYTE));
    }
    ...
    private void testPartitionedMultiplePages(List<Type> targetTypes)
    {
        ...
        for (int i = 0; i < PAGE_COUNT; i++) {
            pages.add(createPage(targetTypes, POSITION_COUNT + RANDOM.nextInt(POSITION_COUNT), true, false, false, ImmutableList.of()));
            pages.add(createPage(targetTypes, POSITION_COUNT + RANDOM.nextInt(POSITION_COUNT), true, false, true, ImmutableList.of(DICTIONARY, DICTIONARY, RUN_LENGTH)));
            pages.add(createPage(targetTypes, POSITION_COUNT + RANDOM.nextInt(POSITION_COUNT), true, false, true, ImmutableList.of(RUN_LENGTH, DICTIONARY, DICTIONARY)));
        }
    ...
    private void testReplicatedSinglePage(List<Type> targetTypes)
    {
        ...
        Page page = createPage(targetTypes, POSITION_COUNT, true, true, false, ImmutableList.of());
    ...
    private void testReplicatedMultiplePages(List<Type> targetTypes)
    {
        ...
        List<Page> pages = new ArrayList<>();
        for (int i = 0; i < PAGE_COUNT; i++) {
            pages.add(createPage(targetTypes, POSITION_COUNT + RANDOM.nextInt(POSITION_COUNT), true, true, false, ImmutableList.of()));
        }
