        ...
        extends AbstractLongStreamReader
{
            ...
            implements LongInputStream.ResultsConsumer
    {
        ...
        long adjustValue(int offsetIndex, long value)
        {
            if (inDictionaryStream != null) {
                ...
                throws IOException
        {
            ...
            for (int i = 0; i < count; i++) {
                if (!filterDone && !test(offsetIndex + i, value)) {
                    continue;
                }
        ...
        private void addResult(int offsetIndex, long value)
        {
            ...
            if (values != null) {
                values[numResults + numValues] = adjustValue(offsetIndex, value);
            }
            ++numResults;
        }
    }
