        ...
        implements ConnectorPageSource
{
    ...
    public boolean pushdownFilterAndProjection(PageSourceOptions options)
    {
        ...
        for (FilterFunction filterFunction : options.getFilterFunctions()) {
            ...
            if (!evaluateFilterFunction(filterFunction)) {
        ...
        filterAndProjectPushedDown = delegate.pushdownFilterAndProjection(
                new PageSourceOptions(
                        internalChannels,
                        outputChannels,
                        options.getReusePages(),
                        remainingFilterFunctions.build().toArray(new FilterFunction[0]),
    ...
    private boolean evaluateFilterFunction(FilterFunction filterFunction)
    {
